 ...
 * Return: On success 0, or other number if its declared in the arguments
 */
 ...
 * Return: on Success 0, other number if its declared in the argument
 */
 ...
 * @data: struct for the program's data
 * Return: on success 0, or other number if its declared in the argument
 */
